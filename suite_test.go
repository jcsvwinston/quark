...
func SharedSuite(t *testing.T, client *quark.Client) {
	...
	t.Run("MigrationLock", func(t *testing.T) {
	...
	t.Run("BackfillOrchestration", func(t *testing.T) {
		testBackfillOrchestration(ctx, t, client)
	})
	...
	t.Run("JoinBuilder", func(t *testing.T) {
		testJoinBuilder(ctx, t, client)
	})

	t.Run("BB2JoinProjection", func(t *testing.T) {
