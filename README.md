...
Breaking changes are documented in `docs/MIGRATION_vX.Y.Z.md` per version (none for v0.6 or v0.5; [`MIGRATION_v0.4.0.md`](docs/MIGRATION_v0.4.0.md) covers the Join builder rename from v0.3.x). Release notes per version live under [`docs/RELEASE_NOTES_*.md`](docs/).
