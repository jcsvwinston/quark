...
Passing `WithDialect` explicitly is recommended. Auto-detection is useful for
experiments, but dialect choice affects generated SQL in ways you want to make
