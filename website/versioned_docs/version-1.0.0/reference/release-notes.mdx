...
Quark is documented here as a **v0.x** project (currently **v0.13.0** —
late-alpha, not yet v1.0 production-ready). **Phase 6** (codegen + HA +
sharding + benchmarks → v1.0) has substantially delivered all four
pillars; v0.11–v0.13 are the cuts so far.
...
[`docs/RELEASE_NOTES_v0.13.0.md`](https://github.com/jcsvwinston/quark/blob/main/docs/RELEASE_NOTES_v0.13.0.md).
...
v0.10 through v0.13 introduced **no breaking changes**.
