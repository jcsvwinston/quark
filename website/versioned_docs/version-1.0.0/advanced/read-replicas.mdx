...
marked it `Sticky`. Replication lag is therefore something you opt out of at the
call sites that cannot tolerate it, rather than a global mode you have to reason
about everywhere.
