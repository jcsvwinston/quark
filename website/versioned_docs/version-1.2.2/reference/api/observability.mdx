...
{/* Design: [ADR-0019](https://github.com/jcsvwinston/quark/blob/main/docs/adr/0019-inbound-listen-notify-dedicated-conn.md) — inbound LISTEN/NOTIFY on a dedicated connection. */}
