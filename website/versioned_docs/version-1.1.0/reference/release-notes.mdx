...
Quark is **v1.1.0** — a hardening release on the stable `v1.x` line. `v1.x`
keeps API compatibility; breaking changes go to `v2.x`.
...
v0.10 through v1.1 introduced **no breaking changes**.
