...
Quark is documented here as a **v0.x** project (currently v0.9.0 —
late-alpha, not yet v1.0 production-ready). The public surface is broad
and the core is stable, but some APIs may still move before v1.0.
...
[`docs/RELEASE_NOTES_v0.9.0.md`](https://github.com/jcsvwinston/quark/blob/main/docs/RELEASE_NOTES_v0.9.0.md).
