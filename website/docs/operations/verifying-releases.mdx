...
| Asset | What it is |
| --- | --- |
| `quark_<version>_<os>_<arch>.tar.gz` (`.zip` on Windows) | The CLI archive, six in total: Linux, macOS and Windows on amd64 and arm64. |
...
with `go get`, and the module proxy verifies them.
