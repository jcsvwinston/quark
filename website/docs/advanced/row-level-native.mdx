...
The `quark tenant install-rls-policies` CLI in F5-3 will emit these
templates automatically from the models registered on a Client. Until
F5-3 ships, run the DDL manually as part of your migration pipeline.
