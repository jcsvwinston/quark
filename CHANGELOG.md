...
## [1.11.1](https://github.com/jcsvwinston/quark/compare/v1.11.0...v1.11.1) (2026-09-05)
...
* **errors:** la clasificación de errores reconoce lib/pq y se exporta ([#302](https://github.com/jcsvwinston/quark/issues/302)) ([84740d2](https://github.com/jcsvwinston/quark/commit/84740d2c5acba7c091928631250026e32ac5051a))


### Fixed

* **crud:** en SQL Server un insert rechazado devuelve el error del motor. Create manda el INSERT y SCOPE_IDENTITY() en un batch; al rechazarse el INSERT la SELECT responde NULL y el escaneo en int64 fallaba, sustituyendo el error del driver por uno de conversión. Ningún insert rechazado era diagnosticable en MSSQL. ([84740d2](https://github.com/jcsvwinston/quark/commit/84740d2c5acba7c091928631250026e32ac5051a))
...
## [1.5.1](https://github.com/jcsvwinston/quark/compare/v1.5.0...v1.5.1) (2026-08-19)


### Fixed

* **rls:** las escrituras bajo RLS nativo comitean antes de retornar (QCD-FW §1) ([#279](https://github.com/jcsvwinston/quark/issues/279)) ([b765d54](https://github.com/jcsvwinston/quark/commit/b765d54cd8c053e78e12854c07daa0fd9a444a34))
...
* RLS sin fugas en pánico ni errores enmascarados, lane -race y guards de contenido (QK7-1/2/3 + transversales) ([#259](https://github.com/jcsvwinston/quark/issues/259)) ([3ee4ef8](https://github.com/jcsvwinston/quark/commit/3ee4ef8cc1a0cec31101be31e68012f60394159f))
* **rls:** la tx implícita de Create/Update se acota a la operación — sin retención hasta el fin del ctx del caller ([#261](https://github.com/jcsvwinston/quark/issues/261)) ([e2685ca](https://github.com/jcsvwinston/quark/commit/e2685cab6e71adf2737ef606d42d5e52d4f6dcf1)), closes [#252](https://github.com/jcsvwinston/quark/issues/252)
