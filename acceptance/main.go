...
//	cd acceptance && go run . -engines=sqlite
//
//	# los 6 con gate estricto (Oracle requiere su contenedor o SUPERAPP_DSN_ORACLE)
//	cd acceptance && go run . -engines=all -gate=strict
//
...
// (gitignored). Invócalo desde acceptance, o pasa -manifest/-allowlist.
package main
...
import (
	...
	"github.com/jcsvwinston/quark/acceptance/exercise"
